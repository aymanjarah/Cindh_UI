...
class DemandeActivity extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child:EngagementBar(width: width, height: height*0.07, title: 'سبب الحاجة',Hint:'*********',text:'*********', image: 'assets/Search.svg', img_height: 25),
            ),
            SizedBox(height: 25),
            ButtonMain(textSize:12,text: "إيداع الطلب",width: width*0.65, height: 50, colortext: Colors.black,colorBorder:Colors.transparent,color:Color.fromRGBO(218,218,218,1),page: UserType(),  ),
