...
class IndividuLogin extends StatelessWidget {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget> [
            ...
            SizedBox(height: 40,),
            ButtonMain(textSize:12,text: "الدخول",width: width*0.85, height: 50, colortext: Colors.white,colorBorder:Colors.transparent,color:Color.fromRGBO(47,128,	237,10), page: individuProfile(), ),
            SizedBox(height: 30,),
            ButtonMain(textSize:12,text: " تسجيل الدخول",width: width*0.85, height: 50,colortext:Colors.black,colorBorder:Colors.transparent,color:Color.fromRGBO(242,243,248,10), page: UserType(), ),
